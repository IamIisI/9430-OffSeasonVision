...
public class ApproachStationCommand extends Command {
    ...
    public ApproachStationCommand(DriveSubsystem drive, double desiredDistance, double desiredOffset, double angle, PhotonCamera aligningCamera) {
        this.drive = drive;
    ...
    public void end(boolean interrupted) {
        drive.driveRobotRelative(new ChassisSpeeds());
        System.out.println("ApproachStationCommand ended. Interrupted: " + interrupted);
    }
}